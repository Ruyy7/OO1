...
public class Usuario {
	...
	public Propiedad registrarPropiedad(String nombre, String descripcion, double precioxNoche, String direccion,Politica politica) {
		Propiedad propiedad = new Propiedad (nombre,descripcion,precioxNoche,direccion, politica);

...
public class DistribuidoraTest {
	...
	private Distribuidora distribuidora, redCompleta, redprueba;
	...
	public void setUp() {
		...
		this.redprueba = new Distribuidora();
	...
	public void testSetearPrecio() {
		assertNull(this.redprueba.getPrecioKW());
		this.redprueba.precioKWh(20d);
		assertEquals(20d, this.redprueba.getPrecioKW());
	}
}
